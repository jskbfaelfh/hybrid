...
توقيع الطرف الأول (الشركة):                           توقيع الطرف الثاني (العميل):''',
        'contract_template_cash': '''عقد اتفاق وتوريد نظام طاقة شمسية (نقدي)

إنه في تاريخ {تاريخ_التنصيب}، تم الاتفاق بين شركة {اسم_الشركة} ويمثلها المدير المسؤول، وبين العميل المحترم {اسم_العميل}، حامل رقم الهاتف {هاتف_العميل}، والعنوان {عنوان_العميل}.

بنود العقد:
1. يلتزم الطرف الأول (الشركة) بتجهيز وتركيب نظام طاقة شمسية متكامل للطرف الثاني (العميل) بقيمة إجمالية قدرها {المبلغ_الإجمالي} دينار/دولار عراقي مدفوعة نقداً بالكامل.
2. يقر الطرف الأول باستلام كامل المبلغ المتفق عليه نقداً عند التوقيع/التشغيل.
3. يلتزم الطرف الأول بضمان جودة الأجهزة والتركيب حسب وثيقة الضمان المستقلة المرفقة بهذا العقد.
4. يقر الطرف الثاني بمعاينة وتجربة النظام بعد التركيب وقبوله بالحالة المتفق عليها.

توقيع الطرف الأول (الشركة):                           توقيع الطرف الثاني (العميل):''',
        'contract_template_installment': '''عقد اتفاق وتوريد نظام طاقة شمسية (بالأقساط)
...
شركة {اسم_الشركة} تتمنى لكم طاقة مستدامة وآمنة.''',
        'warranty_template_cash': '''وثيقة ضمان وجودة نظام طاقة شمسية (نقدي)

تتشرف شركة {اسم_الشركة} بتقديم شهادة الضمان هذه للعميل المحترم {اسم_العميل} لتركيب نظام الطاقة الشمسية ذو الرقم التعريفي {رقم_العميل} (نظام مجهز بالكامل نقداً).
...
شركة {اسم_الشركة} تتمنى لكم طاقة مستدامة وآمنة.''',
        'warranty_template_installment': '''وثيقة ضمان وجودة نظام طاقة شمسية (بالأقساط)

تتشرف شركة {اسم_الشركة} بتقديم شهادة الضمان هذه للعميل المحترم {اسم_العميل} لتركيب نظام الطاقة الشمسية ذو الرقم التعريفي {رقم_العميل} (نظام مجهز بالأقساط).

شروط وضوابط الضمان:
1. يشمل الضمان كافة القطع المنصبة والمذكورة في تقرير التسليم ضد أي عيوب مصنعية خلال فترات الضمان المحددة لكل قطعة.
2. يعتبر الضمان سارياً وفعالاً طالما يلتزم العميل بسداد الأقساط الشهرية في مواعيدها المحددة. يحق للشركة تعليق خدمات الضمان في حال تأخر السداد لأكثر من قسطين متتاليين.
3. لا يشمل الضمان الأضرار الناتجة عن سوء الاستخدام، العبث بالأجهزة من فنيين غير معتمدين من شركتنا، أو الكوارث الطبيعية والصواعق.

تفاصيل ضمان القطع المجهزة:
{تفاصيل_ضمان_القطع}

شركة {اسم_الشركة} تتمنى لكم طاقة مستدامة وآمنة.''',
        'receipt_template_cash': '''تم قبض مبلغ العمل بالكامل نقداً عند التوقيع/التشغيل. يعتبر هذا الوصل إقراراً رسمياً باستلام المبلغ أعلاه.''',
        'receipt_template_installment': '''تم قبض مبلغ الدفعة الأولى المقدمة المتفق عليها كدفعة تشغيل وتجهيز للمواد المذكورة في العقد الموقع بين الطرفين. يعتبر هذا الوصل إقراراً رسمياً باستلام المبلغ أعلاه.'''
    }

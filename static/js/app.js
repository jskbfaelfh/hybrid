...
function updateViewHeader() {
    ...
    const headers = {
        dashboard: {
            ...
            s: 'أهلاً بك، مدير النظام. إليك نظرة شاملة على أعمال شمس-تك اليوم.'
        },
        customers: {
...
async function addCustomerComponent() {
    ...
    if (!name || qty <= 0 || isNaN(unit_price)) {
...
async function saveCustomerFinancialPlan() {
    const total = parseFloat(document.getElementById('fin-total').value);
